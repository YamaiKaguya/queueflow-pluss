    ...
    return (
        <div className="bg-white border border-gray-100 rounded-2xl shadow-sm p-9">
            ...
            <div className="grid grid-cols-2 gap-x-10 gap-y-6">
                {[
                { label: 'Phone Number', value: profile.phone_no, icon: <Phone size={20} className="text-gray-400" /> },
                { label: 'Email Address', value: profile.email, icon: <Mail size={20} className="text-gray-400" /> },
                { label: 'Birthday', value: profile.birth_date, icon: <Calendar size={20} className="text-gray-400" /> },
                { label: 'Gender', value: profile.gender, icon: <Venus size={20} className="text-gray-400" /> },
