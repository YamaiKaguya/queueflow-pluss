   ...
   if (!selected) {
      return (
         <div className="bg-white rounded-2xl p-6 shadow-sm flex flex-col items-center justify-center">
            <p className="text-base text-gray-500">Select a department to view details</p>
         </div>
      )
   }
  ...
  const eta = selected.ahead * selected.average
   ...
   return (
      ...
      >
         ...
         {/* STATUS */}
         <div className="text-sm grid grid-cols-3 gap-3 text-center ">
         ...
         <div className="mt-auto space-y-3">
            ...
            <button
               type="submit"
               disabled={loading}
               className="w-full bg-blue-600 hover:bg-blue-700 text-white py-3 rounded-xl text-base font-semibold disabled:opacity-40 cursor-pointer"
            >
