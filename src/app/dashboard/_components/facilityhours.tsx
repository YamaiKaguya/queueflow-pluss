...
export function FacilityHours() {
   return (
      <div className="bg-white rounded-[16px] p-5 shadow-sm">
         ...
         {/* Hours */}
         {HOURS.map((h) => (
            <div key={h.day} className="flex justify-between py-1.5 border-b border-gray-100 last:border-b-0">
            <span className="text-[12px] font-medium text-slate-400">{h.day}</span>
