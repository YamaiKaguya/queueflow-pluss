...
import { services } from "@/src/app/joinqueue/_data/data"
...
const next = () => setCurrentIndex((i) => Math.min(i + 1, maxIndex));
   ...
   return (
    <div className="min-h-[calc(100dvh-100px)]  bg-gray-50 flex flex-col justify-center">
      <div className="max-w-[85vw] w-full mx-auto">

         {/* Header */}
         <div className="mb-8">
         <h1 className="text-5xl font-bold text-gray-900">Join Queue</h1>
         ...
         <button className="flex items-center gap-1 text-base text-[var(--primary-color)] hover:text-[var(--primary-color-dark)] font-medium transition-colors">
